        ...
        <div className="flex flex-col items-center md:flex-row justify-center">
          <div className="p-4">
            ...
            <div className="text-center">
              <p className="text-2xl text-gray-800 ">Patrick Sebastien</p>
              <p className="text-xl font-light text-gray-500 ">Developer</p>
          ...
          <div className="p-4">
            <div className="mb-4 text-center opacity-90">
              <a href="#" className="relative block">
                <img
                  alt="profil"
                  src="https://images.pexels.com/photos/7791844/pexels-photo-7791844.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                  className="mx-auto object-cover rounded-full h-40 w-40 "
                />
              </a>
            </div>
            <div className="text-center">
              ...
              <p className="text-xl font-light text-gray-500 ">Founder</p>
              <p className="max-w-xs py-4 font-light text-gray-500 text-md ">
          ...
          <div className="p-4">
            <div className="mb-4 text-center opacity-90">
              <a href="#" className="relative block">
                <img
                  alt="profil"
                  src="https://images.pexels.com/photos/17565787/pexels-photo-17565787/free-photo-of-brunette-by-window.jpeg"
                  className="mx-auto object-cover rounded-full h-40 w-40 "
                />
              </a>
            </div>
            <div className="text-center">
              <p className="text-2xl text-gray-800 ">Thierry Halliday</p>
              <p className="text-xl font-light text-gray-500 ">CTO</p>
              <p className="max-w-xs py-4 font-light text-gray-500 text-md ">
            ...
            <div className="w-full px-8 lg:w-1/2">
              <div className="pb-12 mb-12 border-b lg:mb-0 lg:pb-0 lg:border-b-0">
                <h2 className="mb-4 text-3xl font-bold lg:text-4xl font-heading ">
                  Manage Tasks Effortlessly with Our Platform
                </h2>
                <p className="mb-8 leading-loose text-gray-500 ">
                  Simplify task management! Our platform streamlines the
                  process, making it easy to organize, track, and collaborate on
                  tasks effectively. Say goodbye to complexity.
                </p>
              ...
              <ul className="space-y-12">
                <li className="flex -mx-4">
                  ...
                  <div className="px-4">
                    <h3 className="my-4 text-xl font-semibold ">
                      Responsive Task Elements
                    </h3>
                    <p className="leading-loose text-gray-500 ">
                      Experience responsive task elements that adapt seamlessly
                      to various screen sizes, ensuring an optimal display every
                      time.
                    </p>
                  </div>
                </li>
                <li className="flex -mx-4">
                  ...
                  <div className="px-4">
                    ...
                    <p className="leading-loose text-gray-500 ">
                      Our flexible team ensures 24/7 availability, ready to join
                      and support you on our hotline whenever you need
                      assistance.
                    </p>
                  </div>
                </li>
                <li className="flex -mx-4">
                  ...
                  <div className="px-4">
                    <h3 className="my-4 text-xl font-semibold ">
                      Eco-friendly Task Solutions
                    </h3>
                    <p className="leading-loose text-gray-500 ">
                      Our task management software is ecologically responsible,
                      contributing to a sustainable approach. Green is more than
                      just a color; it's a commitment to a greener future.
                    </p>
                  </div>
                </li>
              </ul>
